...
[Setup]
AppVerName=WinHTTrack Website Copier 3.48-19
AppVersion=3.48.19
...
SignTool=signtool sign /f $qZ:\Mes Documents\certificats\httrack-com\httrack-signing-certificate.pfx$q /d $qHTTrack Website Copier Installer$q /du http://www.httrack.com/ /t http://timestamp.verisign.com/scripts/timstamp.dll $f
...
Source: "O:\HTTrack\httrack\*.*"; Excludes: "*.pdb,*.ncb"; DestDir: "{app}"; CopyMode: alwaysoverwrite
...
Root: HKCU; Subkey: "AppEvents\Schemes\Apps\WinHTTrack\MirrorStarted\.Current"; ValueType: string; ValueData: "{app}\html\server\sfx\silent.wav"; Flags: uninsdeletekey noerror; Tasks: regfiles
Root: HKCU; Subkey: "AppEvents\Schemes\Apps\WinHTTrack\MirrorStarted\.Default"; ValueType: string; ValueData: "{app}\html\server\sfx\silent.wav"; Flags: uninsdeletekey noerror; Tasks: regfiles
Root: HKCU; Subkey: "AppEvents\Schemes\Apps\WinHTTrack\MirrorFinished\.Current"; ValueType: string; ValueData: "{app}\html\server\sfx\silent.wav"; Flags: uninsdeletekey noerror; Tasks: regfiles
...
Root: HKU; Subkey: ".DEFAULT\AppEvents\Schemes\Apps\WinHTTrack\MirrorStarted\.Current"; ValueType: string; ValueData: "{app}\html\server\sfx\silent.wav"; Flags: uninsdeletekey noerror; Tasks: regfiles
Root: HKU; Subkey: ".DEFAULT\AppEvents\Schemes\Apps\WinHTTrack\MirrorStarted\.Default"; ValueType: string; ValueData: "{app}\html\server\sfx\silent.wav"; Flags: uninsdeletekey noerror; Tasks: regfiles
Root: HKU; Subkey: ".DEFAULT\AppEvents\Schemes\Apps\WinHTTrack\MirrorFinished\.Current"; ValueType: string; ValueData: "{app}\html\server\sfx\silent.wav"; Flags: uninsdeletekey noerror; Tasks: regfiles
